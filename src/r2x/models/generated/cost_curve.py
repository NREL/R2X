...
class CostCurve(Component):
    ...
    __properties: ClassVar[List[str]] = ["power_units", "value_curve", "variable_cost_type", "vom_cost"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CostCurve from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CostCurve from a dict"""
        if obj is None:
            return None
