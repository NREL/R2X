...
class IncrementalCurve(Component):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IncrementalCurve from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IncrementalCurve from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "function_data": IncrementalCurveFunctionData.from_dict(obj["function_data"])
