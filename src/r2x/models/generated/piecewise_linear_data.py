...
class PiecewiseLinearData(Component):
    ...
    points: List[PiecewiseLinearDataPointsInner]
    __properties: ClassVar[List[str]] = ["function_type", "points"]
    ...
    def function_type_validate_enum(cls, value):
        ...
        if value not in set(["PIECEWISE_LINEAR"]):
            raise ValueError("must be one of enum values ('PIECEWISE_LINEAR')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PiecewiseLinearData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PiecewiseLinearData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "points": [PiecewiseLinearDataPointsInner.from_dict(_item) for _item in obj["points"]]
