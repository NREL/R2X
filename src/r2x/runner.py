...
def run_system_modifiers(config: Scenario, parser: BaseParser, system: System) -> System:
...
def run_single_scenario(scenario: Scenario, **kwargs) -> None:
    ...
    if scenario.input_model == "infrasys":
        ...
        system = run_system_modifiers(config=scenario, parser=parser, system=system)
